...
import { deleteMyAvatar, getMyProfile, updateMyProfile, uploadMyAvatar } from "../../api/studentApi";
...
function Profile({ onBackToMain }) {
    ...
    const photoObjectUrl = useAuthedObjectUrl(profile.photo);
                ...
                <div className="profile-card">
                    <header className="profile-header">
                        <div className="profile-header-center">
                            <h1 className="profile-header-title">Профиль студента</h1>
                        </div>
