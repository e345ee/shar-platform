...
function TeacherProfile({ onBackToMain, onLogout }) {
  ...
  const [profile, setProfile] = useState({
    ...
    password: "********",
    about:
      "Преподаватель математики с 15-летним стажем работы. Кандидат педагогических наук. Специализируюсь на подготовке студентов к экзаменам.",
    telegramId: "@maria_teacher",
    photoUrl:
