            ...
            <div className="activities-container">
                <header className="activities-header">
                    ...
                    <div className="activities-header-actions">
                        <button className="btn btn-primary btn-add-activity" onClick={handleOpenCreateModal} type="button">
                            <PlusIcon />
                            Создать активность
                        </button>
                        <button className="btn btn-secondary btn-home" onClick={onBackToMain} type="button">
                            <HomeIcon />
                            На главную
                        </button>
                    </div>
                                ...
                                <div key={activity.id} className={`activity-card activity-card-${activity.color}`}>
                                    ...
                                    <div className="activity-info">
                                        ...
                                        <div className="activity-questions">
                                            <button
                                                className="btn btn-secondary btn-sm btn-questions"
                                                type="button"
                                    ...
                                    <div className="activity-actions">
                                        {activity.activityType === "WEEKLY_STAR" && activity.status === "READY" && (
                                            <button
                                                className="activity-action-btn icon-btn btn-schedule-week"
                                                type="button"
                                        ...
                                        {activity.status !== "READY" && (
                                            <button
                                                className="activity-action-btn icon-btn btn-ready"
                                                type="button"
                                                aria-label="Publish"
                                        ...
                                        <button
                                            className="activity-action-btn icon-btn"
                                            type="button"
                                            aria-label="Edit"
