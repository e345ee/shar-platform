...
import AdminPasswordPage from "./components/Pages/AdminPasswordPage";
...
function App() {
  ...
  if (currentPath === "/admin/password" && normalizedRole === "ADMIN") {
    return <AdminPasswordPage onLogout={handleLogout} />;
  }
