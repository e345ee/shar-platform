...
SELECT r.id, 'admin', 'admin@demo.local', '$2b$10$FVpKNvkJNsv32TiDExuewuy2YtOZT1PYRriYIxHZlFhc46lJuKHdG'
FROM role r WHERE r.rolename = 'ADMIN'
    ON CONFLICT DO NOTHING;


INSERT INTO users(role_id, name, email, password)
SELECT r.id, 'methodist_anna', 'anna@demo.local', '$2b$10$bKmYqnW7WQ6Oo94kiRCeC.XRoVt5CQ2p15VANIsYmna/AKRo17.EO'
FROM role r WHERE r.rolename = 'METHODIST'
    ON CONFLICT DO NOTHING;

INSERT INTO users(role_id, name, email, password)
SELECT r.id, 'methodist_boris', 'boris@demo.local', '$2b$10$bKmYqnW7WQ6Oo94kiRCeC.XRoVt5CQ2p15VANIsYmna/AKRo17.EO'
FROM role r WHERE r.rolename = 'METHODIST'
    ON CONFLICT DO NOTHING;


INSERT INTO users(role_id, name, email, password)
SELECT r.id, 'teacher_alex', 'alex@demo.local', '$2b$10$bKmYqnW7WQ6Oo94kiRCeC.XRoVt5CQ2p15VANIsYmna/AKRo17.EO'
FROM role r WHERE r.rolename = 'TEACHER'
    ON CONFLICT DO NOTHING;

INSERT INTO users(role_id, name, email, password)
SELECT r.id, 'teacher_irina', 'irina@demo.local', '$2b$10$bKmYqnW7WQ6Oo94kiRCeC.XRoVt5CQ2p15VANIsYmna/AKRo17.EO'
FROM role r WHERE r.rolename = 'TEACHER'
    ON CONFLICT DO NOTHING;


INSERT INTO users(role_id, name, email, password)
SELECT r.id, 'student_ivan', 'ivan@demo.local', '$2b$10$bKmYqnW7WQ6Oo94kiRCeC.XRoVt5CQ2p15VANIsYmna/AKRo17.EO'
FROM role r WHERE r.rolename = 'STUDENT'
    ON CONFLICT DO NOTHING;

INSERT INTO users(role_id, name, email, password)
SELECT r.id, 'student_maria', 'maria@demo.local', '$2b$10$bKmYqnW7WQ6Oo94kiRCeC.XRoVt5CQ2p15VANIsYmna/AKRo17.EO'
FROM role r WHERE r.rolename = 'STUDENT'
    ON CONFLICT DO NOTHING;

INSERT INTO users(role_id, name, email, password)
SELECT r.id, 'student_oleg', 'oleg@demo.local', '$2b$10$bKmYqnW7WQ6Oo94kiRCeC.XRoVt5CQ2p15VANIsYmna/AKRo17.EO'
FROM role r WHERE r.rolename = 'STUDENT'
    ON CONFLICT DO NOTHING;
